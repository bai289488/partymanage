...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment  method=post action="javascript:void(0)"
			target="_blank">
				...
				<dl class="content">
					...
					<dd id="btn-dd1">
						<span class="new-btn-login-sp">
							<button class="new-btn-login1" type="submit"
...
<script language="javascript">
	...
	GetDateNow();
    $(".new-btn-login1").on('click',function(){
        var vNow = new Date();
        var sNow = "";
        sNow += String(vNow.getFullYear());
        sNow += String(vNow.getMonth() + 1);
        ...
        sNow += String(vNow.getMilliseconds());
        document.getElementById("WIDout_trade_no").value =  sNow;
        var subject = document.getElementById("WIDsubject").value;
        ...
        // $.post("order/pay",order,function(res){
         //   alert(res);
		// })
	})
</script>
